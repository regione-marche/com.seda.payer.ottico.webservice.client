/**
 * ModificaAssociaTemplateResponse.java
 *
...
public class ModificaAssociaTemplateResponse  implements java.io.Serializable {
    private com.seda.payer.ottico.webservice.configurazione.dati.ResponseType response;

    public ModificaAssociaTemplateResponse() {
    }
    ...
    /**
     * Gets the response value for this ModificaAssociaTemplateResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this ModificaAssociaTemplateResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ModificaAssociaTemplateResponse)) return false;
        ModificaAssociaTemplateResponse other = (ModificaAssociaTemplateResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ModificaAssociaTemplateResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.ottico.payer.seda.com", ">ModificaAssociaTemplateResponse"));
