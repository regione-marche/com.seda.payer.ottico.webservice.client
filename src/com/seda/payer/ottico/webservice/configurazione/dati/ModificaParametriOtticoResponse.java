/**
 * ModificaParametriOtticoResponse.java
 *
...
public class ModificaParametriOtticoResponse  implements java.io.Serializable {
    private com.seda.payer.ottico.webservice.configurazione.dati.ResponseType response;

    public ModificaParametriOtticoResponse() {
    }
    ...
    /**
     * Gets the response value for this ModificaParametriOtticoResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this ModificaParametriOtticoResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ModificaParametriOtticoResponse)) return false;
        ModificaParametriOtticoResponse other = (ModificaParametriOtticoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ModificaParametriOtticoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.ottico.payer.seda.com", ">ModificaParametriOtticoResponse"));
