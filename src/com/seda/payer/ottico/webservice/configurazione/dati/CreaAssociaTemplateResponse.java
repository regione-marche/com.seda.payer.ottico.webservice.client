/**
 * CreaAssociaTemplateResponse.java
 *
...
public class CreaAssociaTemplateResponse  implements java.io.Serializable {
    private com.seda.payer.ottico.webservice.configurazione.dati.ResponseType response;

    public CreaAssociaTemplateResponse() {
    }
    ...
    /**
     * Gets the response value for this CreaAssociaTemplateResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this CreaAssociaTemplateResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreaAssociaTemplateResponse)) return false;
        CreaAssociaTemplateResponse other = (CreaAssociaTemplateResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreaAssociaTemplateResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.ottico.payer.seda.com", ">CreaAssociaTemplateResponse"));
