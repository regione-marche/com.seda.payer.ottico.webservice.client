/**
 * EliminaAssociaTemplateResponse.java
 *
...
public class EliminaAssociaTemplateResponse  implements java.io.Serializable {
    private com.seda.payer.ottico.webservice.configurazione.dati.ResponseType response;

    public EliminaAssociaTemplateResponse() {
    }
    ...
    /**
     * Gets the response value for this EliminaAssociaTemplateResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this EliminaAssociaTemplateResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EliminaAssociaTemplateResponse)) return false;
        EliminaAssociaTemplateResponse other = (EliminaAssociaTemplateResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EliminaAssociaTemplateResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.ottico.payer.seda.com", ">EliminaAssociaTemplateResponse"));
