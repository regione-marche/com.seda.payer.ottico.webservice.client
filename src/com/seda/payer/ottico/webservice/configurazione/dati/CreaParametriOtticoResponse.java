/**
 * CreaParametriOtticoResponse.java
 *
...
public class CreaParametriOtticoResponse  implements java.io.Serializable {
    private com.seda.payer.ottico.webservice.configurazione.dati.ResponseType response;

    public CreaParametriOtticoResponse() {
    }
    ...
    /**
     * Gets the response value for this CreaParametriOtticoResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this CreaParametriOtticoResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreaParametriOtticoResponse)) return false;
        CreaParametriOtticoResponse other = (CreaParametriOtticoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreaParametriOtticoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.ottico.payer.seda.com", ">CreaParametriOtticoResponse"));
