/**
 * EliminaParametriOtticoResponse.java
 *
...
public class EliminaParametriOtticoResponse  implements java.io.Serializable {
    private com.seda.payer.ottico.webservice.configurazione.dati.ResponseType response;

    public EliminaParametriOtticoResponse() {
    }
    ...
    /**
     * Gets the response value for this EliminaParametriOtticoResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this EliminaParametriOtticoResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EliminaParametriOtticoResponse)) return false;
        EliminaParametriOtticoResponse other = (EliminaParametriOtticoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EliminaParametriOtticoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.ottico.payer.seda.com", ">EliminaParametriOtticoResponse"));
